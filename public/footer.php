<footer class="bg-dark text-center text-white">
    ...
    <div class="p-4 pb-0">
        ...
        <section class="mb-4">
            ...
            <!-- Admin -->
            <a class="btn btn-outline-light btn-floating m-1" href="../public/admin.php" role="button"><i class="fa-solid fa-a"></i></a>
        </section>
        <!-- Section: Social media -->
    </div>
    <!-- Grid container -->
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        <a class="text-white" href="../public/admin.php" style="text-decoration: none;">Đăng nhập trang quản lý</a>
    </div>
    <!-- Copyright -->
